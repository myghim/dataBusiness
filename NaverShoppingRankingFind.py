...
#content > div.category_lst > div.summary_area > div > a.on
#content > div.category_lst > div.summary_area > div > a.on
number_lst =[
1   ,
2	,
...
catedataframe= pd.DataFrame({"카테고리" : lst_category, "URL" : lst_url})
catedataframe.to_csv("C:/Users/onycom/Documents/어니컴/naver_best100_list.csv", encoding="cp949")